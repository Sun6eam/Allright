...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Allright agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-allright starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-allright" / "runs")
    return Allright(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-allright> ").strip()
