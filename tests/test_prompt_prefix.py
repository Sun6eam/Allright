from allright.prompt_prefix import build_prompt_prefix, tool_signature
from allright.tools import build_tool_registry
from allright.workspace import WorkspaceContext
...
def test_build_prompt_prefix_renders_tools_and_workspace_metadata(tmp_path):
    ...
    assert "You are allright" in prefix.text
